 ...
 * NOTE:
 * 
 * The second column of the table has to be the one which
 * has to be summed. As there has to always be a key, and
 * if there are no other columns it can't be summed upon.
 * 
 */
...
$(document).ready(function() {
    var table=$('#example').DataTable({
      ...
      drawCallback: function () {
        ...
        $("#total-funding").html("<h3>Total Funding: "+totalSum+"</h3>");
      },
      columnDefs: [
            {
                targets: 'last-column',
