    ...
    constructor(object=null,id=null) {
        ...
        if(object==null){
            return;
                ...
                this._Last_Name_Text=checkInput.checkText(object.Last_Name_Text);
            
        
                this._First_Name_Text=checkInput.checkText(object.First_Name_Text);
                ...
                this._Last_Served=checkInput.checkText(object.Last_Served);
            
        
                this._Comments_Text=checkInput.checkText(object.Comments_Text);
            
        
                this._Personal_Website_External=checkInput.checkText(object.Personal_Website_External);
            
        
        
        this._Role_Select=checkInput.checkSelect(object.Role_Select);
        
        this._Role_Within_Univ_Select=checkInput.checkSelect(object.Role_Within_Univ_Select);
        
        this._Gender_Select=checkInput.checkSelect(object.Gender_Select);
        
        this._Non_White_Select=checkInput.checkSelect(object.Non_White_Select);
        
        this._Disability_Select=checkInput.checkSelect(object.Disability_Select);
        
        this._Veteran_Select=checkInput.checkSelect(object.Veteran_Select);
        
        this._Non_National_Select=checkInput.checkSelect(object.Non_National_Select);
        
        this._Year_First_Participated_Select=checkInput.checkSelect(object.Year_First_Participated_Select);
        
        this._Fourth_Gear_Role_Select=checkInput.checkSelect(object.Fourth_Gear_Role_Select);
        
        
        this._Team_Link=checkInput.checkLink(object.Team_Link);
        
        this._Department_Company_Link=checkInput.checkLink(object.Department_Company_Link);
        
        this._Event_Specific_Link=checkInput.checkLink(object.Event_Specific_Link);
